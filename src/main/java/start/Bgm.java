...
public class Bgm {
	...
	public static void playBGM(String path) {
		if (bgmPlayer != null && path.equals(currentPath))
			return;
		stopBGM();
	...
	public static void playStageBGM(int stageNumber) {
		...
		switch (stageNumber) {
		case 1:
			playBGM("/music/stage1_bgm.mp3");
			break;
		case 2:
			playBGM("/music/stage2_bgm.mp3");
			break;
		case 3:
			playBGM("/music/stage3_bgm.mp3");
			break;
		default:
			playBGM("/music/stage1_bgm.mp3");
			break;
	...
	// ピンチ時
	public static void playPinchBGM() {
		playBGM("/music/pinchi.mp3");
	}
